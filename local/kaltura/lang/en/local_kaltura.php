...
$string['enable_submission'] = 'Clone Submissions';
$string['enable_submission_desc'] = 'If enabled, any media submitted via the Kaltura Video Submission flow will be cloned under a different user name to prevent editing and deletion.';
...
$string['launch_url_desc'] = 'Launch URL';
$string['lti1p1'] = 'LTI1.1';
$string['lti1p3'] = 'LTI1.3';
$string['lti_version'] = 'LTI Version';
$string['lti_version_desc'] = 'Choose which LTI version the account works with';
...
$string['privacy:metadata:editor'] = 'The editor of the user accessing the LTI Consumer';
...
$string['public_keyset_desc'] = 'Public keyset URL';
$string['public_keyset_url'] = 'Public keyset URL';
