...
$PAGE->set_url('/mod/kalvidassign/view.php', ['id' => $id]);
...
$event = \mod_kalvidassign\event\assignment_details_viewed::create([
...
if ($CFG->branch < 400) {
    echo $OUTPUT->heading(format_string($kalvidassign->name, true, ['context' => $context]));
}
...
$param = ['vidassignid' => $kalvidassign->id, 'userid' => $USER->id];
...
$PAGE->requires->yui_module('moodle-local_kaltura-ltipanel', 'M.local_kaltura.initmediaassignment', [$params], null, true);
